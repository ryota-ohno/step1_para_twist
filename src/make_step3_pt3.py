...
def get_monomer_xyzR(monomer_name,Ta,Tb,Tc,A1,A2,A3,phi=0.0,isFF=False):
    ...
    df_mono=pd.read_csv('~/Working/step1_para_twist/{}/assets/monomer.csv'.format(monomer_name))
...
def make_gaussview_xyz(auto_dir,monomer_name,params_dict,isInterlayer=False):
    ...
    R3 = params_dict['R3']; R4 = params_dict['R4'];R5= 2*R3-R4
    ...
    if a_>b_:
        monomer_array_p1 = get_monomer_xyzR(monomer_name,0,b_,R4,A1,A2,A3, phi1)
        monomer_array_p2 = get_monomer_xyzR(monomer_name,0,-b_,-R4,A1,A2,A3, phi1)
...
#         monomer_array_ip2 = get_monomer_xyzR(monomer_name,c[0],c[1]-b_,c[2],A1,A2,A3)
        ...
        monomer_array_p1 = get_monomer_xyzR(monomer_name,a_,0,R5,A1,A2,A3, phi1)
        monomer_array_p2 = get_monomer_xyzR(monomer_name,-a_,0,-R5,A1,A2,A3, phi1)
...
def make_gjf_xyz(auto_dir,monomer_name,params_dict,machine_type,isInterlayer):
    ...
    monomer_array_i = get_monomer_xyzR(monomer_name,0,0,0,A1,A2,A3, phi1)
    monomer_array_i2 = get_monomer_xyzR(monomer_name,0,0,0,-A1,-A2,-A3, phi1)
    if a_>b_:
        monomer_array_p1 = get_monomer_xyzR(monomer_name,0,b_,R4,A1,A2,A3, phi1)
        monomer_array_p2 = get_monomer_xyzR(monomer_name,0,b_,R4,-A1,-A2,-A3, phi1)
    ...
    dimer_array_p2 = np.concatenate([monomer_array_i2,monomer_array_p2])
